...
For a table of supported models and regions, visit the [Voice Live API overview](/en-us/azure/ai-services/speech-service/voice-live#supported-models-and-regions).
...
For a full list of client/server events, visit [Voice live API Reference](/en-us/azure/ai-services/speech-service/voice-live-api-reference).
...
![Screenshot of the agent playground with voice mode enabled.](https://learn.microsoft.com/en-us/training/wwl-data-ai/develop-voice-live-agent/media/voice-mode.png)
...
In this unit, you learn how to use the SDK to implement authentication and handle events. You also see a minimal example of creating a session. For a full reference to the Voice Live package, visit the [voice live Package reference](/en-us/python/api/azure-ai-voicelive/azure.ai.voicelive?view=azure-python).
