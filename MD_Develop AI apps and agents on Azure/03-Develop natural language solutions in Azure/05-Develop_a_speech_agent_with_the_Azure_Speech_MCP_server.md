...
![Screenshot of the Tools catalog in the Foundry portal showing the Azure Speech in Foundry Tools connection configuration.](https://learn.microsoft.com/en-us/training/wwl-data-ai/develop-speech-agent-speech-mcp/media/azure-speech-tool-config.png)
