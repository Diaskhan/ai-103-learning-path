...
To learn more about Azure Language in Foundry Tools and some of the concepts covered in this module, refer to the **[Azure Language in Foundry Tools documentation](/en-us/azure/ai-services/language-service?azure-portal=true)**.
