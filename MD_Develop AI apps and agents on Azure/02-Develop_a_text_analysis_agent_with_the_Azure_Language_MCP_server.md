...
To learn more about MCP architecture and how to build custom MCP tool integrations, see the **[Integrate MCP Tools with Azure AI Agents](/en-us/training/modules/connect-agent-to-mcp-tools/)** module.
...
![Screenshot of the Tools catalog in the Foundry portal showing the Azure Language in Foundry Tools connection configuration.](https://learn.microsoft.com/en-us/training/wwl-data-ai/develop-text-analysis-agent-language-mcp/media/azure-language-tool-catalog.png)
