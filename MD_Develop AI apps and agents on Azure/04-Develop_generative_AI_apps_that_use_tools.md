...
The use of *tools* in generative AI model prompts shouldn't be confused with *[Foundry Tools](/en-us/azure/ai-services/reference/sdk-package-resources?azure-portal=true)*; which are Azure AI APIs that you can use in your applications and agents.
...
You can learn more about how to use the Microsoft Foundry Agents SDK to create agents with persisted configurations in [Develop AI agents on Azure](/en-us/training/paths/develop-ai-agents-azure/).
...
![Diagram of an application configuring a model to use tools.](https://learn.microsoft.com/en-us/training/wwl-data-ai/use-generative-ai-tools/media/tools.png)
...
To learn more about using the *Responses* API to submit a prompt to a model in Microsoft Foundry, see the [Develop a generative AI chat app with Microsoft Foundry](/en-us/training/modules/foundry-sdk?azure-portal=true) module.
