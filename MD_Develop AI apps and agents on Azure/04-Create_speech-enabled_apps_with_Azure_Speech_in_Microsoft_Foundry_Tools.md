...
![Diagram showing an Azure Speech resource performing speech-to-text and text-to-speech functions.](https://learn.microsoft.com/en-us/training/wwl-data-ai/create-speech-enabled-apps/media/azure-speech.png)
...
![A diagram showing how a SpeechRecognizer object is created from a SpeechConfig and AudioConfig, and its RecognizeOnceAsync method is used to call the Speech to text API.](https://learn.microsoft.com/en-us/training/wwl-data-ai/create-speech-enabled-apps/media/speech-to-text.png)
...
![A diagram showing how a SpeechSynthesizer object is created from a SpeechConfig and AudioConfig, and its SpeakTextAsync method is used to call the Speech API.](https://learn.microsoft.com/en-us/training/wwl-data-ai/create-speech-enabled-apps/media/text-to-speech.png)
...
For example, the following Python code sets the speech output format for a previously defined **SpeechConfig** object named *speech\_config*:

```
speech_config.set_speech_synthesis_output_format(SpeechSynthesisOutputFormat.Riff24Khz16BitMonoPcm)
```

For a full list of supported formats and their enumeration values, see the [Azure Speech SDK documentation](/en-us/python/api/azure-cognitiveservices-speech/azure.cognitiveservices.speech.speechsynthesisoutputformat).
...
For information about voices, see the [Azure Speech SDK documentation](/en-us/azure/ai-services/speech-service/language-support?tabs=tts).
...
For more information about SSML, see the [Azure Speech SDK documentation](/en-us/azure/ai-services/speech-service/speech-synthesis-markup).
...
To learn more about the Azure Speech, refer to the [Azure Speech in Foundry Tools documentation](/en-us/azure/ai-services/speech-service/).
