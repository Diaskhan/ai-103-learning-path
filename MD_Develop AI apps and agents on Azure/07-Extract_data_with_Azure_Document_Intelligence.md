...
![Screenshot showing Document Intelligence analyzing a sample document with extracted fields and bounding boxes.](https://learn.microsoft.com/en-us/training/wwl-data-ai/extract-data-with-document-intelligence/media/document-intelligence-example.png)
...
![Screenshot showing the Document Intelligence Studio home page.](https://learn.microsoft.com/en-us/training/wwl-data-ai/extract-data-with-document-intelligence/media/document-intelligence-homepage.png)
...
![Screenshot showing the read model analyzing a sample document in the Document Intelligence Studio.](https://learn.microsoft.com/en-us/training/wwl-data-ai/extract-data-with-document-intelligence/media/read-prebuilt-sample.png)
...
![Screenshot showing the layout model extracting tables and structure from a sample document in the Document Intelligence Studio.](https://learn.microsoft.com/en-us/training/wwl-data-ai/extract-data-with-document-intelligence/media/layout-prebuilt-sample.png)
...
| **Language support** | 100+ languages | Fewer languages (check [documentation](/en-us/azure/ai-services/document-intelligence/language-support/custom) for current support) |
