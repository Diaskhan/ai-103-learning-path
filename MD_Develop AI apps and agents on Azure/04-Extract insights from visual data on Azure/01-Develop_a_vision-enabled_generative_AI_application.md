...
To learn more about available models in Microsoft Foundry, see the **[Microsoft Foundry Models overview](/en-us/azure/foundry/concepts/foundry-models-overview)** article in the Microsoft Foundry documentation.
...
![Screenshot of the chat playground with an image-based prompt.](https://learn.microsoft.com/en-us/training/wwl-data-ai/develop-generative-ai-vision-apps/media/image-prompt.png)
...
![Diagram of a multi-part prompt being submitted to a model.](https://learn.microsoft.com/en-us/training/wwl-data-ai/develop-generative-ai-vision-apps/media/multi-part-prompt.png)
