...
![Diagram of Azure AI Search supporting multiple applications.](https://learn.microsoft.com/en-us/training/wwl-data-ai/ai-knowldge-mining/media/ai-search.png)
...
![Diagram of an indexer using a skillset to enrich data.](https://learn.microsoft.com/en-us/training/wwl-data-ai/ai-knowldge-mining/media/skillset.png)
...
To learn more about using custom skills with Azure AI Search, see **[Add a custom skill to an Azure AI Search enrichment pipeline](/en-us/azure/search/cognitive-search-custom-skill-interface)** in the Azure AI Search documentation.
...
![Diagram of a client searching an Azure AI Search index.](https://learn.microsoft.com/en-us/training/wwl-data-ai/ai-knowldge-mining/media/search-index.png)
...
For more information about querying an index, and details about simple and full syntax, see **[Query types and composition in Azure AI Search](/en-us/azure/search/search-query-overview)** in the Azure AI Search documentation.
...
For more information about using filters, see **[Filters in Azure AI Search](/en-us/azure/search/search-filters)** in the Azure AI Search documentation.
...
![Diagram of an indexing process loading projections into a knowledge store.](https://learn.microsoft.com/en-us/training/wwl-data-ai/ai-knowldge-mining/media/knowledge-store.png)

Tip

To learn more about using a knowledge store, see **[Knowledge store in Azure AI Search](/en-us/azure/search/knowledge-store-concept-intro)** in the Azure AI Search documentation.
...
To learn more about Azure AI Search, see the **[Azure AI Search documentation](/en-us/azure/search/)**.
