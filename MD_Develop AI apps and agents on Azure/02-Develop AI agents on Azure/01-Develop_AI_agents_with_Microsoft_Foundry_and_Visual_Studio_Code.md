...
- An understanding of generative AI (recommended: [Fundamentals of Generative AI](/en-us/training/modules/fundamentals-generative-ai/) module)
...
To learn more about GitHub Copilot, explore the [GitHub Copilot fundamentals](/en-us/training/paths/copilot/) learning path.
...
**Model selection** - Choose from [various AI models](/en-us/azure/ai-foundry/agents/concepts/model-region-support?tabs=global-standard#available-models) to match your performance and cost requirements.
...
You can explore more about agents in general with the [Fundamentals of AI agents](/en-us/training/modules/ai-agent-fundamentals) module.
...
- [Fundamentals of AI agents](/en-us/training/modules/ai-agent-fundamentals) - Deepen your understanding of agent concepts and architectures
- [Microsoft Foundry documentation](/en-us/azure/ai-foundry/) - Explore detailed guides and API references
- [GitHub Copilot fundamentals](/en-us/training/paths/copilot/) - Learn about AI agent applications in software development
