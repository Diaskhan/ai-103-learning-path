...
![A screenshot of a group chat workflow in Microsoft Foundry.](https://learn.microsoft.com/en-us/training/wwl-data-ai/build-agent-workflows-microsoft-foundry/media/group-chat-workflow.png)
...
![A screenshot of the Microsoft Foundry workflow designer showing available node types.](https://learn.microsoft.com/en-us/training/wwl-data-ai/build-agent-workflows-microsoft-foundry/media/workflow-add-node.png)
...
![Screenshot of the Invoke agent node parameters showing the response schema configuration.](https://learn.microsoft.com/en-us/training/wwl-data-ai/build-agent-workflows-microsoft-foundry/media/agent-parameters.png)
...
![Screenshot showing how to store agent output in a variable for later use in the workflow.](https://learn.microsoft.com/en-us/training/wwl-data-ai/build-agent-workflows-microsoft-foundry/media/agent-action-settings.png)
...
For more information about the Power Fx language, visit the [Power Fx documentation](/en-us/power-platform/power-fx/overview?azure-portal=true).
...
![Screenshot of a note added to the workflow providing guidance.](https://learn.microsoft.com/en-us/training/wwl-data-ai/build-agent-workflows-microsoft-foundry/media/workflow-note.png)
...
They are ignored once generated, since agents always handle routing automatically

They provide predictable data that can be stored in variables, evaluated with conditions, and trigger workflow steps

They replace the need for loops and If/Else nodes
...
For more information about workflows in Microsoft Foundry, visit the Microsoft Foundry [Create a workflow documentation](/en-us/azure/ai-foundry/agents/concepts/workflow?azure-portal=true).
